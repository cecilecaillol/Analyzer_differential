if __name__ == "__main__":
	...
	factorL=1.2
  	factorT=1.0
        nbhist=1
        postfix_out=["_CMS_promptL_subtraction_et_2018Up"]
    ...
    if options.shape=="subL_down":
        ...
        factorT=1.0
        nbhist=1
        postfix_out=["_CMS_promptL_subtraction_et_2018Down"]
    ...
    if options.shape=="subT_up":
        ...
        factorT=1.2
        nbhist=1
        postfix_out=["_CMS_promptT_subtraction_et_2018Up"]
    ...
    if options.shape=="subT_down":
        ...
        factorT=0.8
        nbhist=1
        postfix_out=["_CMS_promptT_subtraction_et_2018Down"]
    ...
    for k in range(0,nbhist):
      ...
      #print postfix[k],fData.Get("AIvbfhigh/reweighted_data_obs"+postfix[k]).Integral(),fEmbedded.Get("AIvbfhigh/reweighted_data_obs"+postfix[k]).Integral(),fVV.Get("AIvbfhigh/VVT"+postfix[k]).Integral()
      ...
      print fTT.Get("AI0jet/TTT"+postfix[k]).Integral(),fGGH.Get("AI0jet/ggH_htt125T").Integral(),fVBF.Get("AI0jet/qqH_htt125T").Integral()
    ...
    for k in range(0,nbhist):
      ...
      #print postfix_out[k],postfix[k],"et_0jet",h_0jet[k].Integral()
      h_0jet[k].Write()
    ...
    for k in range(0,nbhist):
      ...
      #print postfix_out[k],postfix[k],"et_boosted",h_boosted[k].Integral()
      h_boosted[k].Write()
    ...
    for k in range(0,nbhist):
      ...
      #print postfix_out[k],postfix[k],"et_vbf",h_vbf[k].Integral()
      h_vbf[k].Write()
    ...
    for k in range(0,nbhist):
      ...
      #print postfix_out[k],postfix[k],"et_0jetlow",h_0jetlow[k].Integral()
      h_0jetlow[k].Write()
    ...
    for k in range(0,nbhist):
      ...
      #print postfix_out[k],postfix[k],"et_0jethigh",h_0jethigh[k].Integral()
      h_0jethigh[k].Write()
    ...
    for k in range(0,nbhist):
      ...
      if k==0: print postfix_out[k],postfix[k],"et_boosted1",h_boosted1[k].Integral()
      h_boosted1[k].Write()
    ...
    for k in range(0,nbhist):
      ...
      #print postfix_out[k],postfix[k],"et_boosted2",h_boosted2[k].Integral()
      h_boosted2[k].Write()
    ...
    for k in range(0,nbhist):
      ...
      #print postfix_out[k],postfix[k],"et_vbflow",h_vbflow[k].Integral()
      h_vbflow[k].Write()
    ...
    for k in range(0,nbhist):
      ...
      #print postfix_out[k],postfix[k],"et_vbfhigh",h_vbfhigh[k].Integral()
      h_vbfhigh[k].Write()
