if __name__ == "__main__":
    ...
    fTTfake=ROOT.TFile("files_"+options.directory+"_em/TTfake.root","r")
    ...
    for c in range(0,ncat):
      ...
      for k in range(0,nbhist):
        ...
        #h_0jetZL[k].Add(fTTfake.Get("SS"+categories[c]+"/W"+postfix[k]))
        #h_0jetZL[k].Add(fDY.Get("SS"+categories[c]+"/W"+postfix[k]))
        #h_0jetZL[k].Add(fDY.Get("SS"+categories[c]+"/ZL"+postfix[k]))
 	#print fData.Get("SS"+categories[c]+"/data_obs"+postfix[k]).Integral(),fEmbedded.Get("SS"+categories[c]+"/embedded"+postfix[k]).Integral(),fDY.Get("SS"+categories[c]+"/ZL"+postfix[k]).Integral()
        #h_0jetZL[k].Add(fVV.Get("SS"+categories[c]+"/STL"+postfix[k]))
        ...
        #hAI_0jetZL[k].Add(fDY.Get("AI"+categories[c]+"/ZL"+postfix[k]))
        #hAI_0jetZL[k].Add(fVV.Get("AI"+categories[c]+"/STL"+postfix[k]))
        hAI_0jetZL[k].Add(fVV.Get("AI"+categories[c]+"/VVL"+postfix[k]))
        hAI_0jetZL[k].Add(fDY.Get("AI"+categories[c]+"/ZL"+postfix[k])) #FIXME
        hAI_0jetZL[k].Add(fVV.Get("AI"+categories[c]+"/STL"+postfix[k]))#FIXME
	...
	hAI_0jet[k].Scale(h_0jet[k].Integral()/(hAI_0jet[k].Integral()+1))
