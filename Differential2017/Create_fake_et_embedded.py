if __name__ == "__main__":
	...
	factorL=1.2
  	factorT=1.0
        nbhist=1
        postfix_out=["_CMS_promptL_subtraction_et_2017Up"]
    ...
    if options.shape=="subL_down":
        ...
        factorT=1.0
        nbhist=1
        postfix_out=["_CMS_promptL_subtraction_et_2017Down"]
    ...
    if options.shape=="subT_up":
        ...
        factorT=1.2
        nbhist=1
        postfix_out=["_CMS_promptT_subtraction_et_2017Up"]
    ...
    if options.shape=="subT_down":
        ...
        factorT=0.8
        nbhist=1
        postfix_out=["_CMS_promptT_subtraction_et_2017Down"]
