...
int main(int argc, char** argv) {
   ...
   else if (is_higgs) nbhist=1+84+18+8;
   ...
   // control 1
   /*float bins_mtt0[] = {24,26,28,30,32,34,36,38,40,42,44,46,48,50,52,54,56,58,60,62,64,66,68,70,72,74,76,78,80,82,84,86,88,90,92,94,96,98,100};
   ...
   TH1F* h_msv=new TH1F("h_msv","h_msv",50,50,200);
...
cout<<get_name_puhisto(input)<<endl;
   ...
   TString postfixMC[85]={"","_CMS_scale_t_1prong_2017Down","_CMS_scale_t_1prong_2017Up","_CMS_scale_t_1prong1pizero_2017Down","_CMS_scale_t_1prong1pizero_2017Up","_CMS_scale_t_3prong_2017Down","_CMS_scale_t_3prong_2017Up","_CMS_scale_t_3prong1pizero_2017Down","_CMS_scale_t_3prong1pizero_2017Up","_CMS_tauideff_pt30to35_2017Down","_CMS_tauideff_pt30to35_2017Up","_CMS_tauideff_pt35to40_2017Down","_CMS_tauideff_pt35to40_2017Up","_CMS_tauideff_ptgt40_2017Down","_CMS_tauideff_ptgt40_2017Up","_CMS_scale_j_AbsoluteDown","_CMS_scale_j_AbsoluteUp","_CMS_scale_j_Absolute_2017Down","_CMS_scale_j_Absolute_2017Up","_CMS_scale_j_BBEC1Down","_CMS_scale_j_BBEC1Up","_CMS_scale_j_BBEC1_2017Down","_CMS_scale_j_BBEC1_2017Up","_CMS_scale_j_EC2Down","_CMS_scale_j_EC2Up","_CMS_scale_j_EC2_2017Down","_CMS_scale_j_EC2_2017Up","_CMS_scale_j_FlavorQCDDown","_CMS_scale_j_FlavorQCDUp","_CMS_scale_j_HFDown","_CMS_scale_j_HFUp","_CMS_scale_j_HF_2017Down","_CMS_scale_j_HF_2017Up","_CMS_scale_j_RelativeBalDown","_CMS_scale_j_RelativeBalUp","_CMS_scale_j_RelativeSample_2017Down","_CMS_scale_j_RelativeSample_2017Up","_CMS_res_j_2017Down","_CMS_res_j_2017Up","_CMS_scale_efaket_1prong_barrel_2017Down","_CMS_scale_efaket_1prong_barrel_2017Up","_CMS_scale_efaket_1prong1pizero_barrel_2017Down","_CMS_scale_efaket_1prong1pizero_barrel_2017Up","_CMS_scale_efaket_1prong_endcap_2017Down","_CMS_scale_efaket_1prong_endcap_2017Up","_CMS_scale_efaket_1prong1pizero_endcap_2017Down","_CMS_scale_efaket_1prong1pizero_endcap_2017Up","_CMS_scale_met_unclustered_2017Down","_CMS_scale_met_unclustered_2017Up","_CMS_htt_boson_reso_met_0jet_2017Down","_CMS_htt_boson_reso_met_0jet_2017Up","_CMS_htt_boson_scale_met_0jet_2017Down","_CMS_htt_boson_scale_met_0jet_2017Up","_CMS_htt_boson_reso_met_1jet_2017Down","_CMS_htt_boson_reso_met_1jet_2017Up","_CMS_htt_boson_scale_met_1jet_2017Down","_CMS_htt_boson_scale_met_1jet_2017Up","_CMS_htt_boson_reso_met_2jet_2017Down","_CMS_htt_boson_reso_met_2jet_2017Up","_CMS_htt_boson_scale_met_2jet_2017Down","_CMS_htt_boson_scale_met_2jet_2017Up","_CMS_htt_ttbarShapeDown","_CMS_htt_ttbarShapeUp","_CMS_htt_dyShapeDown","_CMS_htt_dyShapeUp","_CMS_scale_e_2017Down","_CMS_scale_e_2017Up","_CMS_prefiringDown","_CMS_prefiringUp","_CMS_singleeletrg_2017Down","_CMS_singleeletrg_2017Up","_CMS_eletautrg_2017Down","_CMS_eletautrg_2017Up","_CMS_efaket_norm_pt30to50_2017Down","_CMS_efaket_norm_pt30to50_2017Up","_CMS_efaket_norm_pt50to70_2017Down","_CMS_efaket_norm_pt50to70_2017Up","_CMS_efaket_norm_ptgt70_2017Down","_CMS_efaket_norm_ptgt70_2017Up","_CMS_etauFR_barrel_2017Down","_CMS_etauFR_barrel_2017Up","_CMS_etauFR_endcap_2017Down","_CMS_etauFR_endcap_2017Up","_CMS_looser_lep_wp_etau_2017Down","_CMS_looser_lep_wp_etau_2017Up"};
   ...
   TString postfixEmbedded[33]={"","_CMS_scale_emb_t_1prong_2017Down","_CMS_scale_emb_t_1prong_2017Up","_CMS_scale_emb_t_1prong1pizero_2017Down","_CMS_scale_emb_t_1prong1pizero_2017Up","_CMS_scale_emb_t_3prong_2017Down","_CMS_scale_emb_t_3prong_2017Up","_CMS_scale_emb_t_3prong1pizero_2017Down","_CMS_scale_emb_t_3prong1pizero_2017Up","_CMS_scale_emb_e_barrel_2017Down","_CMS_scale_emb_e_barrel_2017Up","_CMS_scale_emb_e_endcap_2017Down","_CMS_scale_emb_e_endcap_2017Up","_CMS_singleeletrg_emb_2017Down","_CMS_singleeletrg_emb_2017Up","_CMS_eletautrg_emb_2017Down","_CMS_eletautrg_emb_2017Up","_CMS_eff_t_embedded_pt30to35_2017Down","_CMS_eff_t_embedded_pt30to35_2017Up","_CMS_eff_t_embedded_pt35to40_2017Down","_CMS_eff_t_embedded_pt35to40_2017Up","_CMS_eff_t_embedded_ptgt40_2017Down","_CMS_eff_t_embedded_ptgt40_2017Up","_CMS_eff_prong_emb_2017Down","_CMS_eff_prong_emb_2017Up","_CMS_eff_1prong1pizero_emb_2017Down","_CMS_eff_1prong1pizero_emb_2017Up","_CMS_eff_3prong1pizero_emb_2017Down","_CMS_eff_3prong1pizero_emb_2017Up","_CMS_EmbeddedZeroJet_2017Down","_CMS_EmbeddedZeroJet_2017Up","_CMS_looser_lep_wp_etau_2017Down","_CMS_looser_lep_wp_etau_2017Up"};
   ...
   TString postfixFF[89]={"","_CMS_rawFF_et_qcd_0jet_barrel_unc1_2017Up","_CMS_rawFF_et_qcd_0jet_barrel_unc2_2017Up","_CMS_rawFF_et_qcd_0jet_barrel_unc1_2017Down","_CMS_rawFF_et_qcd_0jet_barrel_unc2_2017Down","_CMS_rawFF_et_qcd_1jet_barrel_unc1_2017Up","_CMS_rawFF_et_qcd_1jet_barrel_unc2_2017Up","_CMS_rawFF_et_qcd_1jet_barrel_unc1_2017Down","_CMS_rawFF_et_qcd_1jet_barrel_unc2_2017Down","_CMS_rawFF_et_qcd_2jet_barrel_unc1_2017Up","_CMS_rawFF_et_qcd_2jet_barrel_unc2_2017Up","_CMS_rawFF_et_qcd_2jet_barrel_unc1_2017Down","_CMS_rawFF_et_qcd_2jet_barrel_unc2_2017Down","_CMS_rawFF_et_w_0jet_barrel_unc1_2017Up","_CMS_rawFF_et_w_0jet_barrel_unc2_2017Up","_CMS_rawFF_et_w_0jet_barrel_unc1_2017Down","_CMS_rawFF_et_w_0jet_barrel_unc2_2017Down","_CMS_rawFF_et_w_1jet_barrel_unc1_2017Up","_CMS_rawFF_et_w_1jet_barrel_unc2_2017Up","_CMS_rawFF_et_w_1jet_barrel_unc1_2017Down","_CMS_rawFF_et_w_1jet_barrel_unc2_2017Down","_CMS_rawFF_et_w_2jet_barrel_unc1_2017Up","_CMS_rawFF_et_w_2jet_barrel_unc2_2017Up","_CMS_rawFF_et_w_2jet_barrel_unc1_2017Down","_CMS_rawFF_et_w_2jet_barrel_unc2_2017Down","_CMS_rawFF_et_qcd_0jet_endcap_unc1_2017Up","_CMS_rawFF_et_qcd_0jet_endcap_unc2_2017Up","_CMS_rawFF_et_qcd_0jet_endcap_unc1_2017Down","_CMS_rawFF_et_qcd_0jet_endcap_unc2_2017Down","_CMS_rawFF_et_qcd_1jet_endcap_unc1_2017Up","_CMS_rawFF_et_qcd_1jet_endcap_unc2_2017Up","_CMS_rawFF_et_qcd_1jet_endcap_unc1_2017Down","_CMS_rawFF_et_qcd_1jet_endcap_unc2_2017Down","_CMS_rawFF_et_qcd_2jet_endcap_unc1_2017Up","_CMS_rawFF_et_qcd_2jet_endcap_unc2_2017Up","_CMS_rawFF_et_qcd_2jet_endcap_unc1_2017Down","_CMS_rawFF_et_qcd_2jet_endcap_unc2_2017Down","_CMS_rawFF_et_w_0jet_endcap_unc1_2017Up","_CMS_rawFF_et_w_0jet_endcap_unc2_2017Up","_CMS_rawFF_et_w_0jet_endcap_unc1_2017Down","_CMS_rawFF_et_w_0jet_endcap_unc2_2017Down","_CMS_rawFF_et_w_1jet_endcap_unc1_2017Up","_CMS_rawFF_et_w_1jet_endcap_unc2_2017Up","_CMS_rawFF_et_w_1jet_endcap_unc1_2017Down","_CMS_rawFF_et_w_1jet_endcap_unc2_2017Down","_CMS_rawFF_et_w_2jet_endcap_unc1_2017Up","_CMS_rawFF_et_w_2jet_endcap_unc2_2017Up","_CMS_rawFF_et_w_2jet_endcap_unc1_2017Down","_CMS_rawFF_et_w_2jet_endcap_unc2_2017Down","_CMS_rawFF_et_tt_unc1_2017Up","_CMS_rawFF_et_tt_unc2_2017Up","_CMS_rawFF_et_tt_unc1_2017Down","_CMS_rawFF_et_tt_unc2_2017Down","_CMS_FF_closure_lpt_et_qcd_2017Up","_CMS_FF_closure_lpt_et_qcd_2017Down","_CMS_FF_closure_lpt_xtrg_et_qcd_2017Up","_CMS_FF_closure_lpt_xtrg_et_qcd_2017Down","_CMS_FF_closure_lpt_et_w_2017Up","_CMS_FF_closure_lpt_et_w_2017Down","_CMS_FF_closure_lpt_xtrg_et_w_2017Up","_CMS_FF_closure_lpt_xtrg_et_w_2017Down","_CMS_FF_closure_lpt_et_tt_2017Up","_CMS_FF_closure_lpt_et_tt_2017Down","_CMS_FF_closure_lpt_xtrg_et_tt_2017Up","_CMS_FF_closure_lpt_xtrg_et_tt_2017Down","_CMS_FF_closure_OSSS_mvis_et_qcd_2017Up","_CMS_FF_closure_OSSS_mvis_et_qcd_2017Down","_CMS_FF_closure_pth_0jet_et_w_2017Up","_CMS_FF_closure_pth_0jet_et_w_2017Down","_CMS_FF_closure_ljpt_pth0to45_et_w_2017Up","_CMS_FF_closure_ljpt_pth0to45_et_w_2017Down","_CMS_FF_closure_ljpt_pth45to80_et_w_2017Up","_CMS_FF_closure_ljpt_pth45to80_et_w_2017Down","_CMS_FF_closure_ljpt_pth80to120_et_w_2017Up","_CMS_FF_closure_ljpt_pth80to120_et_w_2017Down","_CMS_FF_closure_ljpt_pth120to200_et_w_2017Up","_CMS_FF_closure_ljpt_pth120to200_et_w_2017Down","_CMS_FF_closure_ljpt_pthgt200_et_w_2017Up","_CMS_FF_closure_ljpt_pthgt200_et_w_2017Down","_CMS_FF_norm_et_0jet_2017Up","_CMS_FF_norm_et_0jet_2017Down","_CMS_FF_norm_et_1jet_2017Up","_CMS_FF_norm_et_1jet_2017Down","_CMS_FF_norm_et_2jet_2017Up","_CMS_FF_norm_et_2jet_2017Down","_CMS_FF_norm_et_3jet_2017Up","_CMS_FF_norm_et_3jet_2017Down","_CMS_FF_norm_et_4jet_2017Up","_CMS_FF_norm_et_4jet_2017Down"};
	...
	// Top pT reweighting
	  ...
	  aweight=aweight*wmc->function("e_idiso_ic_embed_ratio")->getVal();
          ...
          if ((trigger27 or trigger32) && myele.Pt()>28 && (fabs(myele.Eta())<1.479 or myele.Pt()>40)){
              ...
              if (wmc->function("t_trg_mediumDeepTau_etau_embed_ratio")->getVal()>0){
                 trg_up=wmc->function("t_trg_mediumDeepTau_etau_embed_ratio_up")->getVal()/wmc->function("t_trg_mediumDeepTau_etau_embed_ratio")->getVal();
                 trg_down=wmc->function("t_trg_mediumDeepTau_etau_embed_ratio_down")->getVal()/wmc->function("t_trg_mediumDeepTau_etau_embed_ratio")->getVal();
              }
          }
          ...
          if (trigger2430 && myele.Pt()<28 && fabs(myele.Eta())>1.479){
             ...
             if (wmc->function("t_trg_mediumDeepTau_etau_data")->getVal()>0){
                trg_up=wmc->function("t_trg_mediumDeepTau_etau_data_up")->getVal()/wmc->function("t_trg_mediumDeepTau_etau_data")->getVal();
                trg_down=wmc->function("t_trg_mediumDeepTau_etau_data_down")->getVal()/wmc->function("t_trg_mediumDeepTau_etau_data")->getVal();
             }
          }
	}
	   ...
	   massJets=mjj;
           ...
           if (sample=="embedded"){
              if (k>0 && k<9 && gen_match_2==5){ // TES x 8
                if (k==1 && l2_decayMode==0){mytau*=0.9958; mymet=mymet+(0.0042/0.9958)*mytau; mtt=m_sv_DOWN;}
                else if (k==2 && l2_decayMode==0){mytau*=1.0041; mymet=mymet-(0.0041/1.0041)*mytau; mtt=m_sv_UP;}
                else if (k==3 && l2_decayMode==1){mytau*=0.9979; mymet=mymet+(0.0021/0.9979)*mytau; mtt=m_sv_DOWN;}
                else if (k==4 && l2_decayMode==1){mytau*=1.0052; mymet=mymet-(0.0052/1.0052)*mytau; mtt=m_sv_UP;}
                else if (k==5 && l2_decayMode==10){mytau*=0.9954; mymet=mymet+(0.0046/0.9954)*mytau; mtt=m_sv_DOWN;}
                else if (k==6 && l2_decayMode==10){mytau*=1.0044; mymet=mymet-(0.0044/1.0044)*mytau; mtt=m_sv_UP;}
                else if (k==7 && l2_decayMode==11){mytau*=0.9954; mymet=mymet+(0.0046/0.9954)*mytau; mtt=m_sv_DOWN;}
                else if (k==8 && l2_decayMode==11){mytau*=1.0044; mymet=mymet-(0.0044/1.0044)*mytau; mtt=m_sv_UP;}
              }
                ...
                else if (k==15 && myele.Pt()<33){weight2=0.98*trg_down;}
                else if (k==16 && myele.Pt()<33){weight2=1.02*trg_up;}
              }
              else if (k>16 && k<23 && byMediumDeepVSjet_2 && gen_match_2==5){
           ...
           if (sample!="data_obs" && sample!="embedded"){
              if (k>0 && k<9 && (name=="embedded" or gen_match_2==5)){ // TES x 8
              ...
              else if (sample!="embedded" && k>14 && k<39){ // JES x 24
              ...
              else if (sample!="embedded" && k>38 && k<47 && (gen_match_2<5)){ // e->tau fake ES x 4
                if (k==39 && l2_decayMode==0 && fabs(mytau.Eta())<1.5){mytau*=0.99118; mymet=mymet+(0.00882/0.99118)*mytau; mtt=m_sv_DOWN;}
                else if (k==40 && l2_decayMode==0 && fabs(mytau.Eta())<1.5){mytau*=1.01343; mymet=mymet-(0.01343/1.01343)*mytau; mtt=m_sv_UP;}
                else if (k==41 && l2_decayMode==1 && fabs(mytau.Eta())<1.5){mytau*=0.99027; mymet=mymet+(0.00973/0.99027)*mytau; mtt=m_sv_DOWN;}
                else if (k==42 && l2_decayMode==1 && fabs(mytau.Eta())<1.5){mytau*=1.02162; mymet=mymet-(0.02162/1.02162)*mytau; mtt=m_sv_UP;}
                else if (k==43 && l2_decayMode==0 && fabs(mytau.Eta())>1.5){mytau*=0.98570; mymet=mymet+(0.01430/0.98570)*mytau; mtt=m_sv_DOWN;}
                else if (k==44 && l2_decayMode==0 && fabs(mytau.Eta())>1.5){mytau*=1.02249; mymet=mymet-(0.02249/1.02249)*mytau; mtt=m_sv_UP;}
                else if (k==45 && l2_decayMode==1 && fabs(mytau.Eta())>1.5){mytau*=0.95031; mymet=mymet+(0.04969/0.95031)*mytau; mtt=m_sv_DOWN;}
                else if (k==46 && l2_decayMode==1 && fabs(mytau.Eta())>1.5){mytau*=1.06461; mymet=mymet-(0.06461/1.06461)*mytau; mtt=m_sv_UP;}
              }
              else if ((name=="ST" or name=="TT" or name=="VV") && k>46 && k<49){ // UES x 2
              ...
              else if (!(name=="ST" or name=="TT" or name=="VV") && k>48 && k<61){ // recoil x 12
                if (njets==0 and k==49){mymet.SetPtEtaPhiM(met_resolutionDown, 0, metphi_resolutionDown, 0); mtt=m_sv_ResolutionDown;}
                else if (njets==0 and k==50){mymet.SetPtEtaPhiM(met_resolutionUp, 0, metphi_resolutionUp, 0); mtt=m_sv_ResolutionUp;}
                else if (njets==0 and k==51){mymet.SetPtEtaPhiM(met_responseDown, 0, metphi_responseDown, 0); mtt=m_sv_ResponseDown;}
                else if (njets==0 and k==52){mymet.SetPtEtaPhiM(met_responseUp, 0, metphi_responseUp, 0); mtt=m_sv_ResponseUp;}
                else if (njets==1 and k==53){mymet.SetPtEtaPhiM(met_resolutionDown, 0, metphi_resolutionDown, 0); mtt=m_sv_ResolutionDown;}
                else if (njets==1 and k==54){mymet.SetPtEtaPhiM(met_resolutionUp, 0, metphi_resolutionUp, 0); mtt=m_sv_ResolutionUp;}
                else if (njets==1 and k==55){mymet.SetPtEtaPhiM(met_responseDown, 0, metphi_responseDown, 0); mtt=m_sv_ResponseDown;}
                else if (njets==1 and k==56){mymet.SetPtEtaPhiM(met_responseUp, 0, metphi_responseUp, 0); mtt=m_sv_ResponseUp;}
                else if (njets>1 and k==57){mymet.SetPtEtaPhiM(met_resolutionDown, 0, metphi_resolutionDown, 0); mtt=m_sv_ResolutionDown;}
                else if (njets>1 and k==58){mymet.SetPtEtaPhiM(met_resolutionUp, 0, metphi_resolutionUp, 0); mtt=m_sv_ResolutionUp;}
                else if (njets>1 and k==59){mymet.SetPtEtaPhiM(met_responseDown, 0, metphi_responseDown, 0); mtt=m_sv_ResponseDown;}
                else if (njets>1 and k==60){mymet.SetPtEtaPhiM(met_responseUp, 0, metphi_responseUp, 0); mtt=m_sv_ResponseUp;}
              }
              else if (k>60 && k<63 && name=="TT"){ //Top pt reweighting x 2
                if (k==61) weight2=1.0/topfactor;
                else if (k==62) weight2=topfactor;
              }
              else if (k>62 && k<65 && (sample=="DY" or sample=="Z")){ //Top pt reweighting x 2
                if (k==63) weight2=(zptweight-0.10*(zptweight-1))/zptweight;
                else if (k==64) weight2=(zptweight+0.10*(zptweight-1))/zptweight;
              }
              if (k>64 && k<67){ // EES x 2 
              ...
              if (k>66 && k<69){
                if (k==67) {weight2=prefiring_weight_down/(prefiring_weight+0.00000001);}
                else if (k==68) {weight2=prefiring_weight_up/(prefiring_weight+0.00000001);}
              }
              else if (k>68 && k<73){ // TRG x 4 
                if (k==69 && myele.Pt()>28){weight2=0.98;}
                else if (k==70 && myele.Pt()>28){weight2=1.02;}
                else if (k==71 && myele.Pt()<28){weight2=0.98;}
                else if (k==72 && myele.Pt()<28){weight2=1.02;}
              }
              else if (k>72 && k<83){
                if (k==73 && gen_match_2<5 && mytau.Pt()>=30 && mytau.Pt()<50) {weight2=0.90;}
                else if (k==74 && (gen_match_2==1 or gen_match_2==3) && mytau.Pt()>=30 && mytau.Pt()<50) {weight2=1.10;}
                else if (k==75 && (gen_match_2==1 or gen_match_2==3) && mytau.Pt()>=50 && mytau.Pt()<70) {weight2=0.90;}
                else if (k==76 && (gen_match_2==1 or gen_match_2==3) && mytau.Pt()>=50 && mytau.Pt()<70) {weight2=1.10;}
                else if (k==77 && (gen_match_2==1 or gen_match_2==3) && mytau.Pt()>=70) {weight2=0.70;}
                else if (k==78 && (gen_match_2==1 or gen_match_2==3) && mytau.Pt()>=70) {weight2=1.30;}
                else if (k==79 && (gen_match_2==1 or gen_match_2==3) && fabs(mytau.Eta())<1.460) {weight2=1.32;}
                else if (k==80 && (gen_match_2==1 or gen_match_2==3) && fabs(mytau.Eta())<1.460) {weight2=0.68;}
                else if (k==81 && (gen_match_2==1 or gen_match_2==3) && fabs(mytau.Eta())>1.460) {weight2=1.38;}
                else if (k==82 && (gen_match_2==1 or gen_match_2==3) && fabs(mytau.Eta())>1.460) {weight2=0.62;}
              }
              else if (k>82 && k<85){ // looser lep
                if (k==83 and mytau.Pt()<100 and gen_match_2==5) weight2=0.97;
                else if (k==83 and mytau.Pt()>=100 and gen_match_2==5) weight2=0.85;
                else if (k==84 and mytau.Pt()<100 and gen_match_2==5) weight2=1.03;
                else if (k==84 and mytau.Pt()>=100 and gen_match_2==5) weight2=1.15;
              }
              else if (is_higgs && (k>84 && k<93)){ // muR muF scale x 2 x 4
                if (k==85 and (sample=="qqH" or sample=="qqH_htt125" or sample=="VBFHWW")) weight2=lheweight_nominalTo0p5_average*(lheweight_muR0p5_muF0p5/lheweight_nominal);
                else if (k==86 and (sample=="qqH" or sample=="qqH_htt125" or sample=="VBFHWW")) weight2=lheweight_nominalTo2_average*(lheweight_muR2_muF2/lheweight_nominal);
                if (k==87 and (sample=="WplusH125" or sample=="WminusH125" or sample=="ZH125" or sample=="WminusHWW" or sample=="WplusHWW" or sample=="ZHWW")) weight2=lheweight_nominalTo0p5_average*(lheweight_muR0p5_muF0p5/lheweight_nominal);
                else if (k==88 and (sample=="WplusH125" or sample=="WminusH125" or sample=="ZH125" or sample=="WminusHWW" or sample=="WplusHWW" or sample=="ZHWW")) weight2=lheweight_nominalTo2_average*(lheweight_muR2_muF2/lheweight_nominal);
                if (k==89 and (sample=="GGZHLLTT125" or sample=="GGZHNNTT125" or sample=="GGZHQQTT125" or sample=="GGZHWW")) weight2=lheweight_nominalTo0p5_average*(lheweight_muR0p5_muF0p5/lheweight_nominal);
                else if (k==90 and (sample=="GGZHLLTT125" or sample=="GGZHNNTT125" or sample=="GGZHQQTT125" or sample=="GGZHWW")) weight2=lheweight_nominalTo2_average*(lheweight_muR2_muF2/lheweight_nominal);
                if (k==91 and (sample=="ttHTT")) weight2=lheweight_nominalTo0p5_average*(lheweight_muR0p5_muF0p5/lheweight_nominal);
                else if (k==92 and (sample=="ttHTT")) weight2=lheweight_nominalTo2_average*(lheweight_muR2_muF2/lheweight_nominal);
              }
              else if (is_higgs && (sample=="ggH_htt125" or sample=="ggH" or sample=="GGHWW") && k>92 && k<111){ // WG1 x 18
                if (k==93) weight2=WG1unc_average[0]*(1+WG1unc[0]);
                else if (k==94) weight2=WG1unc_average[1]*(1-WG1unc[0]);
                else if (k==95) weight2=WG1unc_average[2]*(1+WG1unc[1]);
                else if (k==96) weight2=WG1unc_average[3]*(1-WG1unc[1]);
                else if (k==97) weight2=WG1unc_average[4]*(1+WG1unc[2]);
                else if (k==98) weight2=WG1unc_average[5]*(1-WG1unc[2]);
                else if (k==99) weight2=WG1unc_average[6]*(1+WG1unc[3]);
                else if (k==100) weight2=WG1unc_average[7]*(1-WG1unc[3]);
                else if (k==101) weight2=WG1unc_average[8]*(1+WG1unc[4]);
                else if (k==102) weight2=WG1unc_average[9]*(1-WG1unc[4]);
                else if (k==103) weight2=WG1unc_average[10]*(1+WG1unc[5]);
                else if (k==104) weight2=WG1unc_average[11]*(1-WG1unc[5]);
                else if (k==105) weight2=WG1unc_average[12]*(1+WG1unc[6]);
                else if (k==106) weight2=WG1unc_average[13]*(1-WG1unc[6]);
                else if (k==107) weight2=WG1unc_average[14]*(1+WG1unc[7]);
                else if (k==108) weight2=WG1unc_average[15]*(1-WG1unc[7]);
                else if (k==109) weight2=WG1unc_average[16]*(1+WG1unc[8]);
                else if (k==110) weight2=WG1unc_average[17]*(1-WG1unc[8]);
              }
	   }

           if (name=="ST" or name=="VV" or name=="DY" or sample=="Z" or name=="TT"){
              if (k>84 && k<173){ // FF 
                FF=1.0*get_ff(rawtaupt, mytau.Eta(), rawmt, rawmvis, m_sv, myrawele.Pt(), myrawmet.Pt(), rawpth, jpt_1, rawnjets, is_xtrg, frac_tt, frac_qcd, frac_w,FFsys[k-1-84]);
              }
           }
           if (sample=="data_obs"){
              if (k>0 && k<89){ // FF 
                FF=1.0*get_ff(rawtaupt, mytau.Eta(), rawmt, rawmvis, m_sv, myrawele.Pt(), myrawmet.Pt(), rawpth, jpt_1, rawnjets, is_xtrg, frac_tt, frac_qcd, frac_w,FFsys[k-1]);
              }
           }
           if (sample=="embedded"){
              if (k>32 && k<121){ // FF 
                FF=1.0*get_ff(rawtaupt, mytau.Eta(), rawmt, rawmvis, m_sv, myrawele.Pt(), myrawmet.Pt(), rawpth, jpt_1, rawnjets, is_xtrg, frac_tt, frac_qcd, frac_w,FFsys[k-32-1]);
              }
           }
...
/*if (sample=="embedded" && numberJets==0 && 1.05*(myele+mytau+mymet).Pt()<50 or 1.05*(myele+mytau+mymet).Pt()>70) weight2*=0.9;
if (sample=="embedded" && numberJets==0 && 1.05*(myele+mytau+mymet).Pt()>50 && 1.05*(myele+mytau+mymet).Pt()<60) weight2*=0.8;
if (sample=="embedded" && numberJets==0 && 1.05*(myele+mytau+mymet).Pt()>60 && 1.05*(myele+mytau+mymet).Pt()<70) weight2*=0.65;*/
...
//if (k==0 and signalRegion and q_1*q_2<0 and mt<50) cout<<mytau.Pt()<<" "<<gen_tauh_pt<<" "<<gentau2_pt<<" "<<genpt_2<<endl;

	   // Fill SR histograms

           bool category_0=false;
           if (!do_differential && do_control_plots==0 && myele.DeltaR(mytau)>2.0 && numberJets==0 && mt<50) category_0=true;
...
//if (category_0 && q_1*q_2<0 && k==0 && signalRegion && myvar0>45 && myvar0<80 && mass0>90 && mass0<130) cout<<myvar0<<" "<<mass0<<" "<<myele.Pt()<<" "<<mytau.Pt()<<" "<<aweight<<" "<<weight2<<endl;
	       if (k==0 && signalRegion) h_msv->Fill(m_sv);
           ...
           if (myele.DeltaR(mytau)>2.0 && !do_differential && do_control_plots==0 && numberJets==0 && myele.DeltaR(mytau)<=3.0 && mt<50) category_4=true;
    ...
    for (int k=0; k<nbhist; ++k){
       ...
       else if (sample!="data_obs" and name!="embedded" and !is_higgs and k>84) postfix=postfixFF[k-84];
       else if (is_higgs and k>84) postfix=postfixTheo[k-84];
