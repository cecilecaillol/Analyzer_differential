...
rm -f $exefilename
g++ $1 -o $exefilename `root-config --cflags --glibs` -lRooFit -lRooFitCore /afs/cern.ch/work/c/ccaillol/SMHTT2017/CMSSW_9_4_0/lib/slc6_amd64_gcc630/libHTTutilitiesJet2TauFakes.so /afs/cern.ch/work/c/ccaillol/SMHTT2017/CMSSW_9_4_0/lib/slc6_amd64_gcc630/libTauAnalysisToolsTauTriggerSFs.so
echo ""
