if __name__ == "__main__":
    ...
    nbhist=1
    #nbhist=15
    #postfix=["","_CMS_QCD_njet0_intercept_2017Down","_CMS_QCD_njet0_intercept_2017Up","_CMS_QCD_njet0_slope_2017Down","_CMS_QCD_njet0_slope_2017Up","_CMS_QCD_njet1_intercept_2017Down","_CMS_QCD_njet1_intercept_2017Up","_CMS_QCD_njet1_slope_2017Down","_CMS_QCD_njet1_slope_2017Up","_CMS_QCD_njet2_intercept_2017Down","_CMS_QCD_njet2_intercept_2017Up","_CMS_QCD_njet2_slope_2017Down","_CMS_QCD_njet2_slope_2017Up","_CMS_QCD_antiiso_2017Down","_CMS_QCD_antiiso_2017Up"]
    nbhist=37
    ...
    for c in range(0,ncat):
      ...
      for k in range(0,nbhist):
        ...
        print fData.Get("SS"+categories[c]+"/data_obs"+postfix[k]).Integral()
        h_0jetZTT.append(fEmbedded.Get("SS"+categories[c]+"/ZT"+postfix[k]))
	print fEmbedded.Get("SS"+categories[c]+"/ZT"+postfix[k]).Integral()
        h_0jetZL.append(fTT.Get("SS"+categories[c]+"/TTL"+postfix[k]))
        h_0jetZL[k].Add(fVV.Get("SS"+categories[c]+"/VVL"+postfix[k]))
        #h_0jetZL[k].Add(fDY.Get("SS"+categories[c]+"/ZL"+postfix[k])) #FIXME
        h_0jetZL[k].Add(fVV.Get("SS"+categories[c]+"/STL"+postfix[k])) #FIXME
        h_0jetZL.append(fTT.Get("SS"+categories[c]+"/TTT"+postfix[k]))
        h_0jetZL[k].Add(fVV.Get("SS"+categories[c]+"/VVT"+postfix[k]))
        h_0jetZL[k].Add(fVV.Get("SS"+categories[c]+"/STT"+postfix[k])) #FIXME
        ...
        hAI_0jetZL.append(fTT.Get("AI"+categories[c]+"/TTL"+postfix[k]))
        hAI_0jetZL[k].Add(fVV.Get("AI"+categories[c]+"/VVL"+postfix[k]))
        hAI_0jetZL[k].Add(fTT.Get("AI"+categories[c]+"/TTT"+postfix[k]))
        hAI_0jetZL[k].Add(fVV.Get("AI"+categories[c]+"/VVT"+postfix[k]))
        hAI_0jetZL[k].Add(fVV.Get("AI"+categories[c]+"/STL"+postfix[k]))
        hAI_0jetZL[k].Add(fVV.Get("AI"+categories[c]+"/STT"+postfix[k]))
